 ...
 * 现有 serde 属性**，不统一。
 */
export type Command = { "Input": { text: string, } } | { "Undo": { granularity: Granularity, force: boolean, } } | "Redo" | "Cancel" | { "RemoteToolResult": { agent: AgentId, call_id: ToolCallId, content: string, is_error: boolean, } } | "Shutdown";
