...
**M1–M18 全部完成**（2026-08-01 ~ 08-13，M17 的 157 后置见下）。M18 子 agent 上限
...
真机口令实验 + 跨二进制 sha256 全过（154–156、158）；157（wasm 同路）**后置**等
另一会话的 agent-wasm capabilities 工作合并。M16 Rust 扩展包：146–149 前半（截获注册表 /
