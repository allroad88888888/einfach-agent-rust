...
mod http_capabilities_prefix;
mod http_capabilities_prefix_inherit_after_restart;
mod http_capabilities_prefix_survive_restart;
...
mod http_uploads;
mod prefix_decl_indep;
mod prefix_decl_name_reject_indep;
mod prefix_decl_reject_indep;
mod prefix_decl_undo_indep;
