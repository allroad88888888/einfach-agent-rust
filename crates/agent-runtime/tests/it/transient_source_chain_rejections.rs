//! A private source continuation rejects public text and every non-source tool call.
...
#[test]
fn text_mixed_with_a_source_call_fails_closed() {
    assert_rejected("transient-source-mixed-text", mixed_text_source_response());
}
