...
#[test]
fn slot_all_has_twenty_four_entries_including_host_prefix_with_an_empty_default() {
    assert_eq!(
        Slot::ALL.len(),
        24,
        "154 把 Slot::ALL 加到 21 个，205 追加 Inbox → 22、209 追加 Notes → 23、\
         212 追加 AwaitingOn → 24（决策 35）"
    );
